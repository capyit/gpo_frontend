            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        ...
                        case 1: return [2 /*return*/, _b.apply(_a, [(_c.url = (_d.sent()) + "/api/participants/check",
                ...
                div("." + participants_module_css_1.default.overview, [
                    ...
                    div("." + participants_module_css_1.default.participantsTable, [
                        div("." + participants_module_css_1.default.defRow, [
                            ...
                            div("." + participants_module_css_1.default.def, "Anmeldung"),
                        ]),
                        Participants.list.map(function (k) {
                            return div("." + participants_module_css_1.default.entryRow, [
                                ...
                                div("." + participants_module_css_1.default.entry, button({
                                    onclick: function () {
                                        return __awaiter(this, void 0, void 0, function () {
                                            return __generator(this, function (_a) {
                                                switch (_a.label) {
